...
Private Const HOLIDAY_SHEET As String = "�x��"
Private Const SETTINGS_SHEET As String = "�ݒ�"
...
Public Sub RefreshWBS()
    ...
    MsgBox "WBS���Čv�Z���܂����B�\��E���сE�J�~�i�������m�F���Ă��������B", vbInformation
    Exit Sub

CleanFail:
    Application.EnableEvents = True
    Application.ScreenUpdating = True
    MsgBox "�Čv�Z���ɃG���[���������܂���: " & Err.Description, vbExclamation
End Sub
...
Public Sub InputWBSRow()
    ...
    If Len(taskType) = 0 Then taskType = "�^�X�N"
...
Public Sub SetProjectPeriod()
    ...
    startText = InputBox("�v���W�F�N�g�J�n������͂��Ă��������iyyyy/m�j�B", "�v���W�F�N�g����", Format$(Worksheets(SETTINGS_SHEET).Range("B4").Value, "yyyy/m"))
    If Len(startText) = 0 Or Not IsDate(startText) Then Exit Sub
    endText = InputBox("�v���W�F�N�g�I��������͂��Ă��������iyyyy/m�j�B", "�v���W�F�N�g����", Format$(Worksheets(SETTINGS_SHEET).Range("B5").Value, "yyyy/m"))
    ...
    If DateSerial(Year(CDate(endText)), Month(CDate(endText)), 1) < DateSerial(Year(CDate(startText)), Month(CDate(startText)), 1) Then
        MsgBox "�I�����͊J�n���ȍ~���w�肵�Ă��������B", vbExclamation
        Exit Sub
    End If
    ...
    Worksheets(WBS_SHEET).Calculate
    DrawLightningLine
    MsgBox "�K���g�`���[�g�̕\�����Ԃ��X�V���܂����B", vbInformation
End Sub
...
Public Sub AddWBSRow()
    ...
    MsgBox "���͍s��ǉ����܂����B���F�̃Z���ɓ��͂��Ă��������B", vbInformation
End Sub
